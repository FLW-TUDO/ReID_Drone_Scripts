...
def main():
    detector_pallet = Detector("aideck/models/yolov4-tiny.cfg", "aideck/models/yolov4-tiny_pallet.weights", "pallet_bb", "Bounding Box Publisher for pallets", video_device=2)
