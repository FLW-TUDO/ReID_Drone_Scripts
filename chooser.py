...
if __name__ == '__main__':
	...
	pixel_y = [120 * dot(pos, RIGHT_DIR) for pos in positions]
	pixel_x = [120 * dot(pos, DOWN_DIR) for pos in positions]
	...
	def sysOff():
		...
		for crazyflie in nodes:
			...
			uri = "radio://0/{}/1M/E7E7E7E7{}".format(crazyflie["channel"], id) # 2M
